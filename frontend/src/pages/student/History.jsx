...
export default function History() {
  ...
  // Every one of these is derived from state we already have — no separate
  // setState calls needed for loading/error tracking, so no effect can
  // trigger a synchronous cascading render over it.
  const summaryPending =
    selectedCourseId !== "all" && summary?.courseId !== selectedCourseId;
  const summaryFailed =
  ...
  return (
    <div className="min-h-screen bg-paper">
      ...
      <div className="max-w-2xl mx-auto p-4 sm:p-8">
        ...
        {summaryFailed && (
          <div className="bg-danger-bg text-danger text-sm p-3 rounded mb-6 font-medium">
            Could not load attendance summary for this course.
          </div>
        )}
